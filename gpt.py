...
block_size = 256 # what is the maximum conext length for predictions?
max_iters = 5000
learning_rate = 3e-4
...
def forward(self, idx, targets=None):
    ...
    # idx and targets are both (B,T) tensor i=of integers
...
def generates(self, idx, max_new_tokens):
    # idx is (B, T) array of incides in the current context
    for _ in range(max_new_tokens):
        # crop idx to the last blcok_size tokens
        ...
        probs = F.software(logits, dim=-1) # (B,C)
